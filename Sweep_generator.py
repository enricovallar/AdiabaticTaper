...
class sweep_generation:
    """Class for generating sweep simulations."""

    @staticmethod
    def sim_width(path: str = PATH_WIDTH, ratio_array: list = sim_size_ratio):
        """
        Generate simulation models with varying width.

        Args:
            path (str): Path to save the simulation models.
            ratio_array (list): List of width ratios for the simulations.
        """
        env = lumapi.MODE()
    ...
    @staticmethod
    def sim_height(path: str = '../Sweeping_models/Sim_height_FOTONANO', ratio_array: list = sim_size_ratio_FOTONANO_2):
        """
        Generate simulation models with varying height.

        Args:
            path (str): Path to save the simulation models.
            ratio_array (list): List of height ratios for the simulations.
        """
        env = lumapi.MODE()
    ...
    @staticmethod
    def cell_number(path: str = PATH_CELL_NUMBER, cell_number: list = cell_number):
        """
        Generate simulation models with varying cell numbers.

        Args:
            path (str): Path to save the simulation models.
            cell_number (list): List of cell numbers for the simulations.
        """
        env = lumapi.MODE()
    ...
    @staticmethod
    def mesh_width(path: str = PATH_MESH_WIDTH, mesh_size_ratio: list = mesh_size_ratio):
        """
        Generate simulation models with varying mesh width.

        Args:
            path (str): Path to save the simulation models.
            mesh_size_ratio (list): List of mesh width ratios for the simulations.
        """
        env = lumapi.MODE()
    ...
    @staticmethod
    def mesh_height(path: str = PATH_MESH_HEIGHT, mesh_size_ratio: list = mesh_size_ratio):
        """
        Generate simulation models with varying mesh height.

        Args:
            path (str): Path to save the simulation models.
            mesh_size_ratio (list): List of mesh height ratios for the simulations.
        """
        env = lumapi.MODE()
    ...
    @staticmethod
    def mesh_resolution_width(path: str = PATH_MESH_RESOLUTION_WIDTH, mesh_resolution: list = mesh_resolution):
        """
        Generate simulation models with varying mesh resolution width.

        Args:
            path (str): Path to save the simulation models.
            mesh_resolution (list): List of mesh resolution widths for the simulations.
        """
        env = lumapi.MODE()
    ...
    @staticmethod
    def mesh_resolution_height(path: str = PATH_MESH_RESOLUTION_HEIGHT, mesh_resolution: list = mesh_resolution):
        """
        Generate simulation models with varying mesh resolution height.

        Args:
            path (str): Path to save the simulation models.
            mesh_resolution (list): List of mesh resolution heights for the simulations.
        """
        env = lumapi.MODE()
    ...
    @staticmethod
    def convergence_test(path: str = PATH_WIDTH, ratio_array: list = sim_size_ratio):
        """
        Perform convergence test on simulation models.

        Args:
            path (str): Path to load the simulation models.
            ratio_array (list): List of width ratios for the simulations.
        """
        res = []
